...
<div class="table">
    {#each data as token, i}
        ...
        <div class="token" class:expand={expanded} class:first={i===0} class:last={i===data_length-1}>
            <div class="inner">
                <div class="wrapper">
            ...
            <div class="expand">
                <div class="wrapper" bind:clientHeight={expand_height[token.id]} style={
                    expanded?"margin-top: 0;":`margin-top: -${expand_height[token.id] || 0}px;`
                }>
                    {#if atoken}
                        <h1>Actual token</h1>
